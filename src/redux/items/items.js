...
import { getItemByTypeAsync, rateItemAsync, getAllItemsAsync, addItemAsync, deleteItemAsync, updateItemAsync, borrowItemAsync } from './thunks'
...
export const itemSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getItemByTypeAsync.fulfilled, (state, action) => {
        state.list = action.payload
      })
  }
})
